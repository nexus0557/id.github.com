...
<body>
	...
	<header>
		...
		<div><a href="javascript:;" onclick="fnMove();"><img src="images/header.jpg" alt=""/></a></div>
	</header>
	...
	<main>
		<div class="container">
			...
			<section class="sc4">
				...
				<div class="btn-group nth2">
					<a href="javascript:;" onclick="fnMove();" class=""></a>
					<a href="javascript:;" onclick="fnMove();"></a>
				</div>
				<img src="images/mc04.jpg" alt=""/>
			</section>
			<section class="sc5">
				<div class="btn-group top">
					<a href="javascript:;" onclick="fnMove();" class="b1"></a>
					<a href="javascript:;" onclick="fnMove();"></a>
				</div>
				<div class="btn-group nth2">
					<a href="javascript:;" onclick="fnMove();" class=""></a>
			...
			<section class="sc6">
				...
				<img src="images/mc06.jpg" alt=""/>
			</section>
			<section class="db">
				<div class="in-db" id="DB">
					<h2><img src="images/db_top.jpg" alt=""/></h2>
					<div class="input-group">
						...
						<h2><img src="images/btn.png" id="submitBtn" alt=""/></h2>
					</div>
					
				</div>
				<div class="list-db">
					<h2><img src="images/db_top2.jpg" alt=""/></h2>
			...
			<section class="sc7"><img src="images/mc07.jpg" alt=""/></section>
		</div>
	</main>
