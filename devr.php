...
<head>
    ...
    <meta property="og:image" content="http://www.ildeung.com/img_tmp/header.jpg" />

    <link href="css/style_dev.css?v=<?php echo date("ymdhis"); ?>" rel="stylesheet" / >
...
<body>
	...
	<header>
		...
		<div><a href="javascript:;" onclick="fnMove();"><img src="img_tmp/header.jpg" alt=""/></a></div>
	</header>

	<main>
		<div class="container">
			<section class="head">
				<img src="img_tmp/head.jpg" alt=""/>
			</section>
			<section class="sc1">
				...
				<img src="img_tmp/mc01.jpg" alt=""/>
			</section>
			<section class="sc2">
				<div class="btn-group top">
					<a href="javascript:;" onclick="fnMove();"></a>
				</div>
				<div class="btn-group nth2 center">
					<a href="javascript:;" onclick="fnMove();"></a>
					<a href="javascript:;" onclick="fnMove();"></a>
				</div>
				<div class="btn-group nth2 bottom">
				...
				<img src="img_tmp/mc02.jpg" alt=""/>
			</section>

			<section class="sc3">
				<div class="btn-group top">
					<a href="javascript:;" onclick="fnMove();" class="a1"></a>
				</div>
			...
			<section class="sc4">
				...
				<img src="img_tmp/mc04.jpg" alt=""/>
			</section>

			<section class="db">
				<div class="in-db" id="DB">
					<h2><img src="img_tmp/db_top.jpg" alt=""/></h2>
					<div class="input-group">
						...
						<select name="" id="deviceModel" class="input-class">
							...
							<option value="아이폰12Mini">아이폰12Mini</option>
							<option value="아이폰12PRO MAX">아이폰12PRO MAX</option>
							<option value="아이폰12PRO">아이폰12PRO</option>
						...
						<h2><img src="img_tmp/btn.png" id="submitBtn" alt=""/></h2>
					</div>
					
				</div>
				<div class="list-db">
					<h2><img src="img_tmp/db_top2.jpg" alt=""/></h2>
					<br/>
	...
	<footer>
			<div class="container">
				...
				<img src="img_tmp/footer.jpg" alt=""/>
			</div>
	</footer>
